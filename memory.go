...
// fork from github.com/go-micro/plugins/v4/sync/memory
// sine the official implementation has ttl bug, the [pr](https://github.com/go-micro/plugins/pull/127) has not been merged yet.
